...
export const GROUND = [
...

  {
    ...
    bans: ['flight'],
    name: 'Deadweight',
    brief: 'One crate, one square, flat ground the whole way. The crate weighs four times what you are used to, and a normal rover simply spins its wheels at it.',
    hint: 'The wheels spin because there is not enough weight on them, and it takes about twice the crate’s own weight to get the grip: eight ballast, sat over the driven axles rather than out on the nose. More wheels barely helps. More weight does.',
    spawn: [0, 1.2, -6],
    groundSize: 110,
    budget: { cost: 85 },
    pieces: [],
