...
/**
 * The levels the game shipped with. New work goes in a pack of its own rather
 * than on the end of this one: at forty-odd levels a single file stops being
 * readable, and several people building levels at once all editing the same
 * array is a merge conflict every time.
 */
export const CORE = [
  {
    id: 'sandbox',
