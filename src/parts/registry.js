...
const PARTS = [
  ...
  },
  {
    ...
    actuator: {
      ...
      maxSpeed: 26,
      maxForce: 90,
      defaultBinding: { mode: 'axis', pos: 'KeyW', neg: 'KeyS' },
    },
  ...
  },
  {
    ...
    colour: 0xd6543f,
    cost: 5,
    grabber: { reach: 0.85, strength: 4200 },
    actuator: {
      kind: 'grab',
      signal: 'toggle',
  ...
  },
  {
    ...
    colour: 0xc9d34e,
    cost: 6,
    thruster: { axis: [0, 1, 0], maxThrust: 150, spin: 42 },
    actuator: {
      kind: 'thrust',
      signal: 'hold',
  ...
  },
  {
    ...
    colour: 0xff7a45,
    cost: 5,
    thruster: { axis: [0, 1, 0], maxThrust: 70, spin: 0 },
    actuator: {
      kind: 'thrust',
      signal: 'hold',
